...
export default function ScrollTolotteryBlock({ selectedPrizes }) {
  const handleClick = () => {
    const lotteryBlock = document.getElementById('lottery')
    console.log(selectedPrizes)
    if (lotteryBlock) {
      lotteryBlock.scrollIntoView({ behavior: 'smooth', block: 'center' })
    } else {
